...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\LENOVO\ArtemioPanzini\yandexManager\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\LENOVO\ArtemioPanzini\yandexManager\venv\Scripts\deactivate.nu'
